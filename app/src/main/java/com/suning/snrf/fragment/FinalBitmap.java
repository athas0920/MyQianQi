...
import com.suning.snrf.fragment.bitmap.cache.disc.naming.Md5FileNameGenerator;
import com.suning.snrf.fragment.bitmap.core.DisplayImageOptions;
import com.suning.snrf.fragment.bitmap.core.ImageLoader;
import com.suning.snrf.fragment.bitmap.core.ImageLoaderConfiguration;
import com.suning.snrf.fragment.bitmap.core.assist.DiscCacheUtil;
...
public class FinalBitmap {
	...
	public void display(String uri, ImageView imageView, DisplayImageOptions options, ImageLoadingListener listener){
		imageLoader.displayImage(uri, imageView, options, listener);
	}
	
	/**
	 * 配置图片加载器配置信息，框架提供了一个默认的配置器
	 * @param config
	 */
	 ...
	 * @return
	 */
	public File getDiscCache(String imageUri){
		return DiscCacheUtil.findInCache(imageUri, imageLoader.getDiscCache());
	}
