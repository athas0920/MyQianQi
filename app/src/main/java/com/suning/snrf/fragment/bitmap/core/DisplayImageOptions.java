...
import com.suning.snrf.fragment.bitmap.core.assist.ImageScaleType;
 ...
 * <ul>
 * <li>whether stub image will be displayed in {@link ImageView ImageView} during image loading</li>
 * <li>whether stub image will be displayed in {@link ImageView ImageView} if empty URI is passed</li>
 * <li>whether stub image will be displayed in {@link ImageView ImageView} if image loading fails</li>
 * <li>whether {@link ImageView ImageView} should be reset before image loading start</li>
...
public final class DisplayImageOptions {
	...
	public static class Builder {
		...
		/**
		 * Stub image will be displayed in {@link ImageView ImageView} during image loading
		 *
		...
		/**
		 * Incoming image will be displayed in {@link ImageView ImageView} if empty URI (null or empty
		...
		/**
		 * Incoming image will be displayed in {@link ImageView ImageView} if some error occurs during
		...
		/**
		 * {@link ImageView ImageView} will be reset (set <b>null</b>) before image loading start
		 *
		...
		/** Sets whether {@link ImageView ImageView} will be reset (set <b>null</b>) before image loading start */
