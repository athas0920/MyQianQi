...
import com.suning.snrf.fragment.db.sqlite.CursorUtils;
import com.suning.snrf.fragment.db.sqlite.DbModel;
import com.suning.snrf.fragment.db.sqlite.ManyToOneLazyLoader;
import com.suning.snrf.fragment.db.sqlite.OneToManyLazyLoader;
import com.suning.snrf.fragment.db.sqlite.SqlBuilder;
import com.suning.snrf.fragment.db.sqlite.SqlInfo;
import com.suning.snrf.fragment.db.table.KeyValue;
import com.suning.snrf.fragment.db.table.ManyToOne;
import com.suning.snrf.fragment.db.table.OneToMany;
import com.suning.snrf.fragment.db.table.TableInfo;
...
public class FinalDb {
    ...
    public void save(Object entity) {
        ...
        exeSqlInfo(SqlBuilder.buildInsertOrUpdateSql(entity));
    }
...
//		}
    ...
    public static class DaoConfig {
        ...
        private String mDbName = "default.db"; // 数据库名字
