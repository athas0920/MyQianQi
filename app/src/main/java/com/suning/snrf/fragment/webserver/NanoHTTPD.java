 ...
 * @param socketthe {@link Socket} for the connection.
 */
 ...
 */
  public enum Method {  GET,   PUT,   POST,   DELETE,   HEAD,   OPTIONS;   static Method lookup(  String method){
