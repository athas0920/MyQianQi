...
import com.suning.snrf.fragment.http.HttpHandler;
import com.suning.snrf.fragment.http.RetryHandler;
import com.suning.snrf.fragment.http.SyncRequestHandler;
...
public class FinalHttp {
	private static final int DEFAULT_SOCKET_BUFFER_SIZE = 8000 * 1024;
	private static final String HEADER_ACCEPT_ENCODING = "Accept-Encoding";
	private static final String ENCODING_GZIP = "gzip";
	private static int maxConnections = 10;
	private static int socketTimeout = 600 * 1000;
	...
	public void configThreadCount(int theadCount) {
		httpThreadCount = theadCount;
	}
