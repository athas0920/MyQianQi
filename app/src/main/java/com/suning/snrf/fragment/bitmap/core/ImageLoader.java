...
import com.suning.snrf.fragment.bitmap.core.assist.FailReason;
import com.suning.snrf.fragment.bitmap.core.assist.FlushedInputStream;
import com.suning.snrf.fragment.bitmap.core.assist.ImageLoadingListener;
import com.suning.snrf.fragment.bitmap.core.assist.ImageSize;
...
import com.suning.snrf.fragment.bitmap.core.assist.SimpleImageLoadingListener;
import com.suning.snrf.fragment.bitmap.core.display.BitmapDisplayer;
import com.suning.snrf.fragment.bitmap.core.display.FakeBitmapDisplayer;
import com.suning.snrf.fragment.bitmap.utils.ImageSizeUtils;
...
public class ImageLoader {
	 ...
	 * {@link ImageLoadingListener#onLoadingComplete(String, View, Bitmap)} callback}.<br />
	 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
	 *
	 * @param uri      Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param listener {@linkplain ImageLoadingListener Listener} for image loading process. Listener fires events on UI
	 ...
	 *                     {@linkplain ImageLoadingListener#onLoadingComplete(String, View, Bitmap)} callback}. Downloaded image will be decoded
