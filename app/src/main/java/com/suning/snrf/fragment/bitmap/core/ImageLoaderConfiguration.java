 ...
 *******************************************************************************/
package com.suning.snrf.fragment.bitmap.core;
...
import com.suning.snrf.fragment.bitmap.cache.disc.impl.UnlimitedDiscCache;
import com.suning.snrf.fragment.bitmap.cache.disc.naming.FileNameGenerator;
import com.suning.snrf.fragment.bitmap.cache.memory.MemoryCacheAware;
import com.suning.snrf.fragment.bitmap.cache.memory.impl.FuzzyKeyMemoryCache;
import com.suning.snrf.fragment.bitmap.core.assist.MemoryCacheUtil;
import com.suning.snrf.fragment.bitmap.core.assist.QueueProcessingType;
import com.suning.snrf.fragment.bitmap.core.decode.ImageDecoder;
import com.suning.snrf.fragment.bitmap.core.download.ImageDownloader;
import com.suning.snrf.fragment.bitmap.core.download.NetworkDeniedImageDownloader;
import com.suning.snrf.fragment.bitmap.core.download.SlowNetworkImageDownloader;
import com.suning.snrf.fragment.bitmap.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 *            an image to {@link Bitmap Bitmap}. <b>Default value - device's screen width</b>
		 * @param maxImageHeightForMemoryCache Maximum image height which will be used for memory saving during decoding
		 *            an image to {@link Bitmap Bitmap}. <b>Default value</b> - device's screen height
		 */
		 ...
		 * @param compressFormat {@link CompressFormat Compress format} downloaded images to
		...
		/**
		 * Sets maximum memory cache size for {@link Bitmap bitmaps} (in bytes).<br />
		 * Default value - 1/8 of available app memory.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.suning.snrf.fragment.bitmap.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		...
		/**
		 * Sets maximum memory cache size (in percent of available app memory) for {@link Bitmap
		 * bitmaps}.<br />
		 * Default value - 1/8 of available app memory.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.suning.snrf.fragment.bitmap.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.suning.snrf.fragment.bitmap.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.suning.snrf.fragment.bitmap.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.suning.snrf.fragment.bitmap.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link com.suning.snrf.fragment.bitmap.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link com.suning.snrf.fragment.bitmap.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.suning.snrf.fragment.bitmap.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link com.suning.snrf.fragment.bitmap.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.suning.snrf.fragment.bitmap.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Consider {@link com.suning.snrf.fragment.bitmap.utils.L#disableLogging()} to disable ImageLoader logging completely (even error logs)
		 */
