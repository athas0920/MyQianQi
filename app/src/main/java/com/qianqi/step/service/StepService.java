package com.qianqi.step.service;
...
import com.qianqi.step.pojo.StepData;
import com.qianqi.step.utils.DbUtils;
...
//            workPlanNotification();
    ...
    private void updateNotification(String content) {
        ...
        builder.setTicker("前旗计步");
        builder.setContentTitle("前旗计步");
        //设置不可清除
    ...
    private void workPlanNotification() {
        ...
        builder.setContentIntent(contentIntent);
        builder.setSmallIcon(R.mipmap.logo);
        builder.setTicker("前旗计步提醒您开始锻炼了");
...
//				.setNumber(number)//显示数量
                .setTicker("前旗计步提醒您开始锻炼了")//通知首次出现在通知栏，带上升动画效果的
