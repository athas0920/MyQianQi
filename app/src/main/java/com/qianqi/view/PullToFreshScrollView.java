 ...
 * <p>
 * /**
 * Created by 14041578 on 2017/4/19.
 */

public class PullToFreshScrollView extends ScrollView {
    ...
    public PullToFreshScrollView(Context context, AttributeSet attrs, int defStyle) {
